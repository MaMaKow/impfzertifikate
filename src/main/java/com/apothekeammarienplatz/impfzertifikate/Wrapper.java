...
public class Wrapper {
    ...
    private WebDriver createRemoteWebDriver() throws MalformedURLException {
        ...
        driver = new RemoteWebDriver(new URL("http://foo.bar.de:4444/wd/hub"), capabilities);
        return driver;
    }
     ...
     * @param stringToEnter
     */
    public static void CustomSendKeys(WebElement element, String stringToEnter) /*throws InterruptedException*/ {
